...
public class App {
    ...
    static List<List<String>> crear_libros(){
    ...
    static List<List<String>> agregar_libro(List<List<String>> libros, List<String> libro){
    ...
    static List<List<String>> buscar_libro(List<List<String>> libros, List<String> filtros){
    ...
    static List<List<String>> editar_libro(List<List<String>> libros, int libro, int campo, String datos){
    	(libros.get(libro)).set((campo-1), datos);
        return libros;
    }
    
    static List<List<String>> borrar_libro(List<List<String>> libros, int libro){
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (opcion != 5){
            ...
            if (opcion == 1){      	
            	...
            	List<List<String>> libro_agregado = agregar_libro(libros, libro);
            	libros = new ArrayList<>(libro_agregado);
                ...
                List<List<String>> libros_buscados = buscar_libro(libros, filtros);
            	...
            	int libro;
                int campo = 0;
                List<List<String>> libros_editados = new ArrayList<>();
                String datos;
                ...
                while(campo != 11){
                    ...
                    if (campo == 1){
                        ...
                        libros_editados = editar_libro(libros, libro, campo, datos);
                        System.out.println("\nCampo editado exitosamente\n");
                    }
                    else if (campo == 2){
                        datos = option.nextLine();
                        System.out.print("Autor (Si tiene mas de un autor, separelo por ;): ");
                ...
                if (libros.size() == 0){
	                ...
	                libro = libro - 1;
	                List<List<String>> libros_borrados = borrar_libro(libros, libro);
